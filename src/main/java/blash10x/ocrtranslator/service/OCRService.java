...
public class OCRService {
  ...
  public BufferedImage drawBoxes(List<Word> words, BufferedImage originalBfImage) {
  ...
  public BufferedImage convertFxImageToBufferedImage(Image fxImage) {
    return SwingFXUtils.fromFXImage(fxImage, null);
  }

  // Helper: BufferedImage를 Mat으로 변환 (모든 BufferedImage 타입을 처리하도록 개선)
  public Mat convertBufferedImageToMat(BufferedImage bImage) {
  ...
  public Image convertBufferedImageToFxImage(BufferedImage bImage) {
